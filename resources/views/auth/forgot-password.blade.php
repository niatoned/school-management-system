                            ...
                            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Your Email" :value="old('email')" required autofocus>
									</div>
								</div>
								  <div class="row">
