					  ...
					  <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($allData as $key => $amount)
							<tr>
								...
								<td><a href="{{ route('fee.amount.edit', $amount->id) }}" class="btn btn-info">Edit</a>
                                <a id="delete" href="{{ route('fee.amount.delete', $amount->id) }}" class="btn btn-danger">Delete</a></td>
							</tr>
						@endforeach
						</tbody>
						<tfoot>
